...
public class CrawlEventer
{
	...
	public void init(String ipAddress, int port)
	{
		...
		this.crawledLinkEventer = new AsyncRemoteEventer<CrawledLinksNotification>(ClientPool.CRAWL().getPool(), this.pool, ClientConfig.EVENT_QUEUE_SIZE, ClientConfig.EVENTER_SIZE, ClientConfig.EVENTING_WAIT_TIME, ClientConfig.EVENTER_WAIT_TIME, ClientConfig.EVENTER_WAIT_ROUND, ClientConfig.EVENT_IDLE_CHECK_DELAY, ClientConfig.EVENT_IDLE_CHECK_PERIOD, Scheduler.GREATFREE().getSchedulerPool());
