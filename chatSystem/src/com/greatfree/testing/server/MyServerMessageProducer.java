...
public class MyServerMessageProducer
{
	...
	private Runner<MessageProducer<MyServerDispatcher>, MyServerProducerDisposer> producerThreader;
	...
	public void init()
	{
		...
		this.producerThreader = new Runner<MessageProducer<MyServerDispatcher>, MyServerProducerDisposer>(new MessageProducer<MyServerDispatcher>(new MyServerDispatcher(ServerConfig.DISPATCHER_POOL_SIZE, ServerConfig.DISPATCHER_POOL_THREAD_POOL_ALIVE_TIME)), new MyServerProducerDisposer());
