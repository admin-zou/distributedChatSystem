	...
	public void run()
	{
		...
		while (!this.isShutdown())
		{
			...
			while (!this.isEmpty())
			{
				...
				result = CoordinatorMulticastReader.COORDINATE().unicastRequest(request.getMessage().getMessage(), Tools.getRandomSetElement(DNServerClientPool.COORDINATE().getPool().getNodeKeys()));
