...
/*
 * The thread is responsible for determining whether the received notification should be anycast or not. 11/26/2014, Bing Li
 */

// Created: 11/21/2016, Bing Li
public class ClientForAnycastNotificationThread extends NotificationQueue<ClientForAnycastNotification>
{
	/*
	 * Initialize the thread. 11/26/2014, Bing Li
	 */
	public ClientForAnycastNotificationThread(int taskSize)
	{
		super(taskSize);
	}
	...
	public void run()
	{
		// The instance of ClientForAnycastNotification. 11/26/2014, Bing Li
		ClientForAnycastNotification notification;
