...
public class DNMulticastor
{
	...
	/*
	 * Disseminate the notification of BroadcastNotification to the children crawlers of the local one. 11/27/2014, Bing Li
	 */
	...
	/*
	 * Disseminate the notification of DNBroadcastRequest to the children crawlers of the local one. 11/27/2014, Bing Li
	 */
	...
	/*
	 * Disseminate the notification of StopDNMultiNotification to the children crawlers of the local one. 11/27/2014, Bing Li
	 */
