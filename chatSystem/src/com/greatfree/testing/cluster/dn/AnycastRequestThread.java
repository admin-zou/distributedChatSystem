...
public class AnycastRequestThread extends BoundBroadcastRequestQueue<DNAnycastRequest, DNAnycastResponse, MulticastMessageDisposer<DNAnycastRequest>>
{
	/*
	 * Initialize the thread. The binder is assigned at this point. 11/29/2014, Bing Li
	 */
	public AnycastRequestThread(IPPort ipPort, FreeClientPool pool, int taskSize, String dispatcherKey, MulticastMessageDisposer<DNAnycastRequest> reqBinder)
	{
