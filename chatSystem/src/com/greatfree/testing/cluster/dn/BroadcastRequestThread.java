...
public class BroadcastRequestThread extends BoundBroadcastRequestQueue<DNBroadcastRequest, DNBroadcastResponse, MulticastMessageDisposer<DNBroadcastRequest>>
{
	/*
	 * Initialize the thread. The binder is assigned at this point. 11/29/2014, Bing Li
	 */
	public BroadcastRequestThread(IPPort ipPort, FreeClientPool pool, int taskSize, String dispatcherKey, MulticastMessageDisposer<DNBroadcastRequest> reqBinder)
	{
