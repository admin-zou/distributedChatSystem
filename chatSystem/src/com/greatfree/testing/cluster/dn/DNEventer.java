...
public class DNEventer
{
	...
	public void init(String ipAddress, int port)
	{
		...
		this.onlineEventer = new SyncRemoteEventer<OnlineNotification>(ClientPool.SERVER().getPool());
		this.registerClientEventer = new SyncRemoteEventer<RegisterClientNotification>(ClientPool.SERVER().getPool());
		this.unregisterClientEventer = new SyncRemoteEventer<UnregisterClientNotification>(ClientPool.SERVER().getPool());
	}
