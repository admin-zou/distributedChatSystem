...
public class ClientMenu
{
	...
	public final static String SIGN_UP = ClientMenu.TAB + "1) Friend List";
	//public final static String SET_WEATHER = ClientMenu.TAB + "2) Set Weather";
	public final static String SET_WEATHER = ClientMenu.TAB + "2) Send to one";
	//public final static String GET_WEATHER = ClientMenu.TAB + "3) Get Weather";
	public final static String GET_WEATHER = ClientMenu.TAB + "3) Send to all";
