...
public class ClientUI
{
	...
	public void send(int option)
	{
		...
		switch (option)
		{
			...
			case MenuOptions.SIGN_UP: //Friend List
			...
			case MenuOptions.SET_WEATHER:
				ClientEventer.NOTIFY().notifyWeather(new Weather(20.6f, "Sunshine", false, 10.0f, Calendar.getInstance().getTime()));
				//Scanner in = new Scanner(System.in);
				//String name = in.nextLine();
				//String port = in.nextLine();
				//ClientEventer.NOTIFY().notifyWeather(new Weather("admin","2345"));
				break;
