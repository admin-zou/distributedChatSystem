...
public class MemoryIORegistry
{
	...
	/*
	 * Remove or unregister an MemoryIO. It is executed when a client is down or the connection gets something wrong. 11/28/2014, Bing Li
	 */
	...
	/*
	 * Remove or unregister all of the registered MemoryIOs. It is executed when the server process is shutdown. 11/28/2014, Bing Li
	 */
